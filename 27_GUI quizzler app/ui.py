...
class QuizInterface:
    ...
    def __init__(self, quiz_brain: QuizBrain):
        ...
        self.canvas = Canvas(width=350, height=400, bg="white")
        self.canvas.grid(row=1, column=0, columnspan=2, pady=50)
        self.question_text = self.canvas.create_text(175, 200,
                                                     width=320,  # Wraps the text into multiline of it exceeds the width
